                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="shoping__cart__item align-middle text-center">
                                    ...
                                    @if (isset($details['harga_diskon']) && $details['harga_diskon'] > 0)
                                        <span class="badge bg-success text-white ml-2">{{ __('Big Sale') }}</span>
                                    @elseif (isset($details['harga_potongan']) && $details['harga_potongan'] > 0)
                                ...
                                <td class="shoping__cart__price align-middle text-center">
                                    @if (isset($details['harga_diskon']) && $details['harga_diskon'] > 0)
                                        {{-- Show the Big Sale price --}}
                                        Rp {{ number_format($details['harga_diskon'], 0, ',', '.') }}
                                    @elseif (isset($details['harga_potongan']) && $details['harga_potongan'] > 0)
                                        {{-- Show the regular discount price (harga_potongan) --}}
                                        Rp {{ number_format($details['harga_potongan'], 0, ',', '.') }}
                                    @else
                                        {{-- Show the regular price (harga_tayang) --}}
