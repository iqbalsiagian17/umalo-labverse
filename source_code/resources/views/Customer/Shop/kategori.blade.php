                            ...
                            <div class="col-lg-4 col-md-3">
                                <div class="filter__option">
                                    @if (isset($currentCategory))
                                        <span style="font-size: 10px;">{{ __('messages.Category') }}: <b>{{ $currentCategory->nama }}</b></span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="product__item">
                                        ...
                                        <div class="product__item__text">
                                            <h6><a
                                                    href="{{ route('Product_customer.user.show', $product->id) }}?source={{ Str::random(10) }}">{{ \Illuminate\Support\Str::limit($product->nama, 20, '...') }}</a>
                                            </h6>
                        ...
                        <div class="row" id="product-list">
                            @foreach ($Product as $product)
                                <div class="col-lg-4 col-md-6 col-sm-6 product__item-container">
                                    <div class="product__item" data-href="{{ route('Product_customer.user.show', $product->id) }}?source={{ Str::random(10) }}">
                                        @php
                                            $imagePath = $product->images->isNotEmpty()
                                                ? $product->images->first()->gambar
                                                : 'path/to/default/image.jpg';
                                        ...
                                        <div class="product__item__pic"
                                            ...
                                            <ul class="product__item__pic__hover">
                                                <li>
                                                    <a href="{{ route('Product_customer.user.show', $product->id) }}?source={{ Str::random(10) }}">
