                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="alamat" name="alamat" value="{{ old('alamat', $userAddress->alamat) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="kota" name="kota" value="{{ old('kota', $userAddress->kota) }}">
                            @if ($errors->has('kota'))
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="kode_pos" name="kode_pos" value="{{ old('kode_pos', $userAddress->kode_pos) }}" maxlength="5">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="provinsi" name="provinsi" value="{{ old('provinsi', $userAddress->provinsi) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="tambahan" name="tambahan" value="{{ old('tambahan', $userAddress->tambahan) }}">
